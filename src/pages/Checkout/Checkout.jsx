...
import { ReactComponent as VnPayIconBlack } from '~/assets/svgIcon/Logo-VNPAY-QR.svg'
			...
			<form onSubmit={handleSubmit(submitLogIn)}>
				<Box sx={{
									...
									<Box key={product._id}
										...
										<Box sx={{ flex: '1', p: '0 20px', }}>
											<Typography variant='body1' sx={{ textTransform: 'capitalize', fontSize: '16px !important' }}>
												{`${product.color === 'other' ? '' : product.color} ${product.fabric === 'other' ? '' : product.fabric} ${product.type === 'top' ? 'shirt' : 'pant'} `}
											</Typography>
					...
					<Box sx={{
						...
						<FormControl sx={{ width: '100%', borderRadius: '8px', border: '1px solid #000', mt: '12px' }}  {...register('isVnPay')}>
								...
								<FormControlLabel
									...
									label={
										<Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
											<Typography variant='body1'>Thanh toán qua VNPAY-QR</Typography>
											<SvgIcon
												component={VnPayIconBlack}
												inheritViewBox
												sx={{
													height: 'auto',
													width: '64px'
