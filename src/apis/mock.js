	...
	storePage: {
		...
		products: [
			...
			},
			{
				...
				brand: 'wrangler',
				thumb: 'https://res.cloudinary.com/dwa6hiofs/image/upload/v1720758661/khaki_o_goqqb2.jpg',
				description: 'Dài x Rộng: 70x50 cm Dài x Rộng: 70x50 cmDài x Rộng: 70x50 cm Dài x Rộng: 70x50 cmDài x Rộng: 70x50 cm Dài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cmDài x Rộng: 70x50 cmDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cmDài x Rộng: 70x50 cmDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cmDài x Rộng: 70x50 cmDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cmDài x Rộng: 70x50 cmDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cmDài x Rộng: 70x50 cmDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm\nDài x Rộng: 70x50 cm',
				price: 150,
				savePercent: 20,
				quantity: 20,
				type: 'top',
...
export const getProduct = (type, page) => {
	const productType = mockData.storePage.products.filter(item => item.type === type)
	const maxProductOfPage = 12
